...
def pose_detection(model, image_path, output_path):
    ...
    # output_path = './shakira/frame25_p.jpg'  # Ensure the output directory exists
...
if __name__ == "__main__":
    pose_detection(model = 'yolo11n-pose.pt',
                   image_path = './shakira/frame25.jpg',
                   output_path = './shakira/frame25_p.jpg')
